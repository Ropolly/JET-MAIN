...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'JET ICU Operations <noreply@jeticu.com>')

# Frontend URL for activation links
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://jeticuops.com')
