...
const handlePrepopulateForm = async (event: any) => {
  ...
  if (data) {
    ...
    // Trip number will be auto-generated by the backend
  }
};
...
// Trip number generation removed - now handled by backend
...
onMounted(() => {
  ...
  // Trip number will be auto-generated by backend
...
const handleSubmit = async (e: Event) => {
  ...
  console.log('Form validation passed - Type:', formData.type);
  ...
  try {
    ...
    // trip_number will be auto-generated by backend if not provided
    const tripData: any = {
      type: formData.type,
    ...
    const newTripNumber = response.data.trip_number;
    const successText = quoteId.value 
      ? `Trip ${newTripNumber} has been created successfully from quote conversion.`
      : `Trip ${newTripNumber} has been created successfully.`;
